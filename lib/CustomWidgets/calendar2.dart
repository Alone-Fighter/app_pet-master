...
class CalendarChangeNotifier2 extends ChangeNotifier {
  ...
  String monthName = '';
  String inter = '';
  setInter(String val) => inter = val;
  String get getInter => inter;
...
class CalendarWeek2 extends StatefulWidget {
  CalendarWeek2({Key? key, this.color, this.height, this.calendarCallBack , this.title , this.buttonText})
      : super(key: key);

  final Color? color;
  final double? height;
  final CalendarCallBack2? calendarCallBack;
  final String? title;
  final String? buttonText;

  @override
  State<CalendarWeek2> createState() => _CalendarWeek2State();
}

class _CalendarWeek2State extends State<CalendarWeek2> {
  ...
  Widget build(BuildContext context) {
    ...
    double size = (w - 60) / 7;
    Provider.of<CalendarChangeNotifier2>(context).init(size);
    return Consumer<CalendarChangeNotifier2>(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                height: 40,
                padding: const EdgeInsets.only(left: 8.0, right: 8.0),
                child: Desparas_inter(
                  onChanged: (val) {
                    value.setInter(val.toString());
                  },
              ...
              //               dateTime.day, dateTime.month, dateTime.year , value.getInter);
              //         },
              //         child: Container(
              //           height: 30,
              //           alignment: Alignment.center,
  ...
  Future pickDateTime(BuildContext context,CalendarChangeNotifier2 value) async {
   ...
   setState(() {
    ...
    widget.calendarCallBack?.call(
        dateTime.day, dateTime.month, dateTime.year , value.getInter,dateTime,isselecteddate,isselecteddtime);
...
abstract class CalendarCallBack2 {
  void call(int day, int month, int year , String inter,DateTime dateTime,bool isselecteddate,bool isselecteddtime);
}