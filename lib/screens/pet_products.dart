...
import 'detail_pet_product.dart';

class Products extends StatelessWidget implements ApiStatusLogin {
            ...
            child: Consumer<ApiService>(
              builder: (context, value, child) {
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: context.read<ApiService>().getProduct2(),
                                      ...
                                      if (snapshot.hasData) {
                                        return ListView(
                                          ...
                                          children: snapshot.data!.docs.map(
                                            ...
                                            // ProductData productData = ProductData.fromJson(document.data()! as Map<String, dynamic>);
                                            return Column(
                                              children: [
                                                const SizedBox(
                                                  height: 20,
...
//kNavigator(context, DetailProduct(data:data ));
                                                      },
                                                      child: Container(
                                                          height: MediaQuery
                                                                      .of(
                                  ...
                                  //             child: Center(
                                  //                 child: getdata2(snapshot.data!.docs[index].id)
                                  //             ),
                                  //           ),
                                  //           SizedBox(
                                  //             height:
  ...
  getdata(x) {
    return StreamBuilder<QuerySnapshot>(
      stream: context.read<ApiService>().getProduct3(x),
          ...
          return Container(
            child: ListView(
              ...
              children: snapshot.data!.docs.map((DocumentSnapshot document) {
                ProductData NewsData = ProductData.fromJson(
