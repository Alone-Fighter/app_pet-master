...
class Oncology extends StatefulWidget  {
  Oncology({Key? key}) : super(key: key);

  @override
  State<Oncology> createState() => _OncologyState();
}

class _OncologyState extends State<Oncology> implements ApiStatusLogin{
                                        ...
                                        SizedBox(
                                          ...
                                          child: ListView(
                                            ...
                                            children: snapshot.data!.docs
                                              ...
                                              if(vetData.expertise=='Oncología.'){
                                                return Container(
