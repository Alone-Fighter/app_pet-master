...
class EditOwner extends StatelessWidget implements ApiStatusSignUp , ApiStatusLogin {
  var phone;
  ...
  EditOwner({Key? key,required this.name,required this.phone,required this.email}) : super(key: key);
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            MyButton('Actualizar', 40.0, 190.0, kDarkBlue,() {
                              value.updateProfileOwnerDetails(context);
                            }),
