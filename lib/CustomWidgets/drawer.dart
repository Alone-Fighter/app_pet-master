                                      ...
                                      children: [
                                        ListTile(
                                          leading: Stack(
                                            children: [
                                              Container(
                                                  ...
                                                  child: (petData.image.length>3) ? ClipRRect(
                                                      borderRadius: BorderRadius.circular(40),
                                                      child: Image.network(petData.image, fit: BoxFit.fill,))
                                          ...
                                          title:  Row(
                                            ...
                                            children: [
                                              Text(petData.name),
                                              Expanded(child:petData.id == value.getSelectedPet ? const Icon(Icons.check , color: Colors.green) : Container())
                                            ],
                                            ),
                                          onTap: () {
                                            kNavigator(context, PetProfile(petId: petData.id,));
                                            if(petData.id != value.getSelectedPet){

                                              print(petData.id.toString()+'this');
                                              value.setSelectedPet(petData.id);
                                            }
                                        ...
                                        Container(
                                          ...
                                          child: ListTile(
                                            ...
                                            onTap: () {
                                             ...
                                             kNavigator(context,Fotos(petId: petData.id));
                                            },
                                          ),
                                        ),
                                        // Container(
