...
class MedicalGeneral extends StatefulWidget {
  MedicalGeneral({Key? key}) : super(key: key);

  @override
  State<MedicalGeneral> createState() => _MedicalGeneralState();
}

class _MedicalGeneralState extends State<MedicalGeneral> implements ApiStatusLogin {
                                        ...
                                        SizedBox(
                                          ...
                                          child: ListView(
                                            ...
                                            children: snapshot.data!.docs
                                              ...
                                              if(vetData.expertise=='Medicina General.'){
                                                return Container(
