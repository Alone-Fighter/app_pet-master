...
class Oftomologi extends StatefulWidget {
  Oftomologi({Key? key}) : super(key: key);

  @override
  State<Oftomologi> createState() => _OftomologiState();
}

class _OftomologiState extends State<Oftomologi>  implements ApiStatusLogin {
                                        ...
                                        SizedBox(
                                          ...
                                          child: ListView(
                                            ...
                                            children: snapshot.data!.docs
                                              ...
                                              if(vetData.expertise=='Oftalmología.'){
                                                return Container(
