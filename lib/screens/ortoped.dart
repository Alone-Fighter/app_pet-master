...
class Ortoped extends StatefulWidget  {
  Ortoped({Key? key}) : super(key: key);

  @override
  State<Ortoped> createState() => _OrtopedState();
}

class _OrtopedState extends State<Ortoped> implements ApiStatusLogin {
                                        ...
                                        SizedBox(
                                          ...
                                          child: ListView(
                                            ...
                                            children: snapshot.data!.docs
                                              ...
                                              if(vetData.expertise=='Ortopedia.'){
                                                return Container(
