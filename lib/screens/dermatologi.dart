...
class Dermatology extends StatefulWidget  {
  Dermatology({Key? key}) : super(key: key);

  @override
  State<Dermatology> createState() => _DermatologyState();
}

class _DermatologyState extends State<Dermatology> implements ApiStatusLogin {
                                        ...
                                        SizedBox(
                                          ...
                                          child: ListView(
                                            ...
                                            children: snapshot.data!.docs
                                              ...
                                              if(vetData.expertise=='Dermatología.'){
                                                return Container(
